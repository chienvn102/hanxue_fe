...
// "Gõ từ" tạm dùng mode=write của flashcard session (gõ nghĩa Việt).
// Sau này tách riêng: gõ pinyin → check, hoặc gõ Hanzi từ pinyin/nghĩa.
function TypeRedirect() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center" role="status" aria-busy="true">
            ...
            <span className="sr-only">Đang vào game gõ từ...</span>
        </div>
    );
}
